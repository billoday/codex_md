...
.. moduleauthor:: Bill ODay <billoday@gmail.com>
"""
...
setup(
    name='codex_md',
    description="CLI to cache markdown files using sqlite",
    ...
    entry_points="""
    [console_scripts]
    codex_md=codex_md.cli:cli
    """,
    python_requires=">=0.0.1",
    license='MIT',  # noqa
    author='Bill ODay',
    author_email='billoday@gmail.com',
    # Use the URL to the github repo.
    url= 'https://github.com/billoday/codex_md',
    download_url=(
        f'https://github.com/billoday/'
        f'codex_md/archive/{version}.tar.gz'
    ),
    keywords=[
